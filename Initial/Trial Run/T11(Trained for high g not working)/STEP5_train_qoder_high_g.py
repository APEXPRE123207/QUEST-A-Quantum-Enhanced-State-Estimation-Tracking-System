        ...
        try:
            ...
            for _ in range(N_EPISODES):
                ...
                for _ in range(num_steps):
                    ...
                    input_state, prev_az = build_training_features(target,
                        prev_az,
                        sim_opts.dt
                    )
                    ...
                    #   0:3 -> acceleration
                    #   3:6 -> velocity change
                    predicted_output = (avg_values[:6] - 0.5) * 40.0

                    true_accel = (np.array(target.velocity) - last_velocity) / sim_opts.dt
...
if __name__ == '__main__':
    ...
    if population.population:
        ...
        with open("champion_genome_6_2.pkl", 'wb') as f:
